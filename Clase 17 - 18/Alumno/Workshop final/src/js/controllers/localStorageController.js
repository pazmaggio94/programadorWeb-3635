...
function localStorageController(){
    console.log('Se cargo el conrolador de local-storage') // esta linea es opcional
    ...
    for(var i = 0; i < localPeople.length; i++){
        ...
        tableBodyNode.append(
            ...
            '<tr id=" ' + id + ' " ><th scope="row">' + id 
            + '</th><td>' + person.name + '</td><td> ' 
            + genderTranslate (person.gender) + ' </td><td> ' + person.height + ' cm' + ' </td><td> ' 
            + person.mass + ' Kg' + '</td><td> ' + eyeTranslate("ES", person.eye_color) 
